...
public class Node1 {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            echo("Node 1 created at port 55556. Try to register at Bootstrap server....");
            String req = "REG node1";
            InetAddress host = InetAddress.getByName("localhost");
            int port = 55555;
            DatagramPacket request = new DatagramPacket(req.getBytes(), req.getBytes().length, host, port);
            sock.send(request);
            ...
            s = new String(data, 0, ackForReg.getLength());
